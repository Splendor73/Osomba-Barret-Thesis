...
from app.api.v1.endpoints import auth, products, auctions, orders, messages, notifications, reviews, payments, users, forum, categories, faq, admin, ai
...
api_router.include_router(faq.router, prefix="/support", tags=["faq"])
