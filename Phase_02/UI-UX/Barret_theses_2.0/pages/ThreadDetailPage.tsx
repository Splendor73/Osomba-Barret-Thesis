          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-6 border border-gray-100">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                />
                <div>
                  <p className="text-gray-900 font-medium">{mockThread.author.name}</p>
              ...
              <div className="prose max-w-none mb-6">
                <p className="text-gray-700 leading-relaxed">{mockThread.body}</p>
              </div>

              {/* Language Selector */}
              <div className="flex items-center gap-2 pt-4 border-t border-gray-200">
                <span className="text-sm text-gray-600 font-medium">Translate:</span>
                <button
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-sm p-6 md:p-8 border-l-4 border-[#46BB39] mb-6">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                />
                <div>
                  <p className="text-gray-900 font-medium">{mockThread.officialAnswer.agent.name}</p>
              ...
              <div className="pt-6 border-t border-green-200">
                <p className="mb-3 text-gray-900 font-medium">Was this helpful?</p>
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => setHelpful(true)}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-all ${
                      helpful === true
                        ? "bg-[#46BB39] text-white border-[#46BB39] shadow-sm"
                        : "bg-white text-gray-700 border-gray-300 hover:border-[#46BB39]"
                    }`}
                  >
                ...
                {helpful !== null && (
                  <p className="mt-3 text-sm text-[#46BB39] font-medium">Thanks for your feedback!</p>
                )}
              </div>
            </div>
